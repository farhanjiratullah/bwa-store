...
@section('title', 'Store Dashboard Details Product')
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="categories_id" class="form-control">
                            <option value="{{ $product->category->id }}">Tidak diganti ({{ $product->category->name }})</option>
        ...
        <div class="row mt-2">
            ...
            <div class="card">
                ...
                <div class="row">
                    @foreach ($product->galleries as $gallery)
                        <div class="col-md-4">
                            <div class="gallery-container">
                                ...
                                class="w-100"
                                />
                                @if ($gallery->where('products_id', $product->id)->count() > 1)
                                    <a href="{{ route('dashboard-product-gallery-delete', $gallery->id) }}" class="delete-gallery"
                                    >
                                        <img
                                            src="/images/product-details-remove.svg"
                                            alt=""
                                        />
                                    </a>
                                @endif
                    ...
                    @endforeach
                    <div class="col-12"><small><i>Foto setidaknya membutuhkan 1</i></small></div>
                    <div class="col-12">
